...
export default ({ drizzle, drizzleState }) => {
  ...
  <div class="input-group">
    ...
    <button class="unit" type="button"><i class="icon ion-md-search"></i></button>
      ...
      <form>
        {/* <div class="segment"> */}
        <MainInput drizzle={drizzle} drizzleState={drizzleState} />
...
class MainInput extends React.Component {
  ...
  async facadeAddress(props) {
    ...
    let address = await props.drizzle.contracts.Generator.methods
      .facadeInstances(facadeAddress)
      .call()
    if (this.is0Address(address)) {
      return null
    }
    return address
  }
    ...
    if (this.state.facadeAddress != newFacade) {
      ...
      if (newFacade != null) {
        ...
        let web3Contract = new web3.eth.Contract(
          CompoundFacade.abi,
          newFacade,
          { from: nextProps.drizzleState.accounts[0] }
        )
      ...
      // Important to update state bef ore removing old facade to prevent state being misaligned
  ...
  render() {
    return (
      <div class="segment">
        ...
        <button class="green" type="button" onClick={this.props.clickHandler}>
